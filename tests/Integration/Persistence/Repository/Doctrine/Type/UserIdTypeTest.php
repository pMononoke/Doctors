...
use App\Infrastructure\Persistence\DoctrineType\UserIdType;
...
class UserIdTypeTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        try {
            $this->type = Type::getType('userId_test');
    ...
    {
        Type::addType('userId_test', UserIdType::class);
    }

    /** @test */
    public function it_can_get_name(): void
    {
        $this->assertEquals('userId', $this->type->getName());
    }
    ...
    public function it_can_convert_to_a_database_value(): void
    {
        ...
        $this->assertEquals($userId, $this->type->convertToDatabaseValue($userId, $this->platform));
    }
