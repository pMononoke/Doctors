...
class ConfigController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('BenDoctorsBundle:Config:index.html.twig', [
    ...
    public function showAction(config $entity)
    {
        ...
        return $this->render('BenDoctorsBundle:Config:show.html.twig', [
            'entity' => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BenDoctorsBundle:Config:new.html.twig', [
            'entity' => $entity,
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('config_show', ['id' => $entity->getId()]));
        }
    ...
    public function editAction(config $entity)
    {
        ...
        return $this->render('BenDoctorsBundle:Config:edit.html.twig', [
            'entity' => $entity,
