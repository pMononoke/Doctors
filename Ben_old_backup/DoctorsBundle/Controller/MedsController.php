...
class MedsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('BenDoctorsBundle:Meds:index.html.twig', [
    ...
    public function ajaxListAction(Request $request)
    {
        ...
        return $this->render('BenDoctorsBundle:Meds:ajax_list.html.twig', [
                    'entities' => $entities,
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('meds_show', ['id' => $entity->getId()]));
        }

        return $this->render('BenDoctorsBundle:Meds:new.html.twig', [
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('BenDoctorsBundle:Meds:show.html.twig', [
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BenDoctorsBundle:Meds:edit.html.twig', [
            'entity' => $entity,
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('meds_edit', ['id' => $id]));
        }
    ...
    public function removeAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $entities = $em->getRepository('BenDoctorsBundle:Meds')->search(['ids' => $ids]);
